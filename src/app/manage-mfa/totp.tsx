...
export const ValidateTotp = () => {
    ...
    const onVerifyCode = form.onSubmit(async (values) => {
        ...
        try {
            ...
            console.error(err)
            form.setFieldError("code", isClerkApiError(err) ? err.errors[0].long_message : 'validating code failed')
        }
    ...
    if (codes.length) {
        return (
            <Flex align="center" direction="column">
                <h3>Backup codes</h3>
                <Button mb="lg" onClick={onComplete}>Done with Codes</Button>
                <Text mb="lg">Store these codes in a safe place. They can be used to login if you lose access to your authenticator app.</Text>
